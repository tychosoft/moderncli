...
auto main([[maybe_unused]] int argc, [[maybe_unused]] char **argv) -> int {
    ...
    maybe<std::optional<int>> opt = some(std::optional<int>(20));
    ...
    std::vector<maybe<int>> maybe_vec = {some(1), some(2), some(3)};
    ...
    std::vector<maybe<int>> sums = {some(1), some(2), some(3), none<int>(), some(4)};
